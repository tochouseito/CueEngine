...
static_assert(std::is_abstract_v<cue::BuildArtifactReader>);
static_assert(std::is_abstract_v<cue::BuildArtifactReadCancellation>);
static_assert(!std::is_copy_constructible_v<cue::BuildArtifactReadLease>);
