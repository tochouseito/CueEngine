...
///
/// Tool executableは起動せず、存在、File Version、Binary種別を検査する。Windows SDKはEngine Build時に記録したRoot、
/// Version、Header、x64 Libraryを検査する。AssertContextは呼出中だけ借用し、返却値は全Dataを所有する。
